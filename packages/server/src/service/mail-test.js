...
const send = async (value) => {
  ...
  if (value.template) {
    try {
      ...
      message = {
        subject: `[Waline Test] ${rendered.subject}`,
        html: mailEmojiUrls.rewrite(rendered.body),
      };
    } catch {
    ...
    message = {
      subject: 'Waline SMTP test',
      text: 'This is a test email from Waline. No reply is required.',
    };
  }
